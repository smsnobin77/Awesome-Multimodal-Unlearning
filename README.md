...
<p align="right" style="width: 45%; float: right; clear: right; margin-left: 16px;">
  <sub><b>Figure:</b> Year-wise distribution of multimodal unlearning papers across Vision–Language Models (VLMs) and Diffusion Models (DMs) from 2022 to 2025.</sub>
</p>
